    ...
    <div class="app-container">
        <div class="filter-container">
            <el-form :inline="true" label-width="110px" label-position="right">
                                <el-row>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.indexCode" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.industryName" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.level" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.industryCode" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
                <el-row>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.src" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
        ...
        <el-dialog title="申万行业分类	编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
            <el-form ref="dataForm" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.indexCode"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.industryName"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.level"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.industryCode"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.src"  placeholder="" />
                </el-form-item>
