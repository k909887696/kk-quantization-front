...
import { get_index_weight_page_list, deleteById, insert, update, get_details } from '@/api/quantization/index_weight_api'
...
export default {
  ...
  methods: {
    getPageList() { // 查询列表分页
      get_index_weight_page_list(this.listQuery).then(response => {
