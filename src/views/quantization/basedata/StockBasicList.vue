    ...
    <div class="app-container">
        <div class="filter-container">
            <el-form :inline="true" label-width="110px" label-position="right">
                        ...
                        <el-form-item label="市场类型（主板/创业板/科创板/CDR）:">
                        ...
                        <el-form-item label="上市状态 L上市 D退市 P暂停上市:">
                        ...
                        <el-form-item label="是否沪深港通标的，N否 H沪股通 S深股通:">
        ...
        <el-dialog title="个股基本信息编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
            <el-form ref="dataForm" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
                        <el-form-item label="ts股票代码" prop="type">
                            <el-input v-model="temp.tsCode" readonly disabled placeholder="ts股票代码"/>
                        </el-form-item>
                        ...
                        <el-form-item label="地域" prop="type">
                            <el-input v-model="temp.area"  placeholder="地域" />
                        </el-form-item>
                        <el-form-item label="所属行业" prop="type">
                            <el-input v-model="temp.industry"  placeholder="所属行业" />
                        </el-form-item>
                        <el-form-item label="股票全称" prop="type">
                            <el-input v-model="temp.fullname"  placeholder="股票全称" />
                        </el-form-item>
                        <el-form-item label="英文全称" prop="type">
                            <el-input v-model="temp.enname"  placeholder="英文全称" />
                        </el-form-item>
                        <el-form-item label="市场类型（主板/创业板/科创板/CDR）" prop="type">
                            <el-input v-model="temp.market"  placeholder="市场类型（主板/创业板/科创板/CDR）" />
                        </el-form-item>
                        <el-form-item label="交易所代码" prop="type">
                            <el-input v-model="temp.exchange"  placeholder="交易所代码" />
                        </el-form-item>
                        <el-form-item label="交易货币" prop="type">
                            <el-input v-model="temp.currType"  placeholder="交易货币" />
                        </el-form-item>
                        <el-form-item label="上市状态 L上市 D退市 P暂停上市" prop="type">
                            <el-input v-model="temp.listStatus"  placeholder="上市状态 L上市 D退市 P暂停上市" />
                        </el-form-item>
                        ...
                        <el-form-item label="是否沪深港通标的，N否 H沪股通 S深股通" prop="type">
                            <el-input v-model="temp.isHs"  placeholder="是否沪深港通标的，N否 H沪股通 S深股通" />
                        </el-form-item>
                        <el-form-item label="拼音缩写" prop="type">
                            <el-input v-model="temp.cnspell"  placeholder="拼音缩写" />
                        </el-form-item>
...
import { getStockBasicPageList, deleteStockBasicById, insertStockBasic, updateStockBasic, getStockBasicDetails } from '@/api/quantization/StockBasicApi'
...
export default {
  ...
  methods: {
      getPageList() { // 查询列表分页
          ...
          getStockBasicPageList(this.listQuery).then(response => {
      ...
      deleteData(row) {
          this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
              ...
              deleteStockBasicById(row).then(response => {
      ...
      updateData() {
          updateStockBasic(this.temp).then(response => {
              this.dialogFormVisible = false
              this.getPageList()
          })
      },
      addData() {
          insertStockBasic(this.temp).then(response => {
              this.dialogFormVisible = false
              this.getPageList()
          })
      },
      editDataDialog(row) {
          ...
          getStockBasicDetails(row).then(response => {
