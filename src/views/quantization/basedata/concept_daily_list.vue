<template>
    <div class="app-container">
        ...
        <el-dialog title="概念日线行情	编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
...
<script>
    ...
    import { get_concept_daily_page_list, deleteById, insert, update, get_details } from '@/api/quantization/concept_daily_api'
    ...
    export default {
        ...
        methods: {
            getPageList() { // 查询列表分页
                get_concept_daily_page_list(this.listQuery).then(response => {
