    ...
    <div class="app-container">
        <div class="filter-container">
            <el-form :inline="true" label-width="110px" label-position="right">
                    ...
                    <el-form-item label=":">
                         <el-input v-model="listQuery.fullname" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.market" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
                <el-row>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.publisher" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.indexType" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.category" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                ...
                <el-row>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.basePoint" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                    ...
                    <el-form-item label=":">
                         <el-input v-model="listQuery.weightRule" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.desc" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
                <el-row>
                    <el-form-item label=":">
        ...
        <el-dialog title="指数基本信息	编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
            <el-form ref="dataForm" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
                ...
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.fullname"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.market"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.publisher"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.indexType"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.category"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                    <el-date-picker v-model="temp.baseDate" type="date" format="yyyyMMdd" value-format="yyyyMMdd" placeholder="选择时间" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.basePoint"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                    <el-date-picker v-model="temp.listDate" type="date" format="yyyyMMdd" value-format="yyyyMMdd" placeholder="选择时间" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.weightRule"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
