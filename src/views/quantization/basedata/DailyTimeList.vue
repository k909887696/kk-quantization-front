<template>
    <div class="app-container">
        <div class="filter-container">
            <el-form :inline="true" label-width="110px" label-position="right">
                        ...
                        <el-form-item label="股票代码:">
                            <el-input v-model="listQuery.tsCode" placeholder="股票代码" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        ...
                        <el-form-item label="交易时间:">
                            <el-input v-model="listQuery.tradeTime" placeholder="交易时间" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        </el-row>
                        <el-row>
                        <el-form-item label="开盘价:">
                            <el-input v-model="listQuery.open" placeholder="开盘价" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        <el-form-item label="最高价:">
                            <el-input v-model="listQuery.high" placeholder="最高价" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        <el-form-item label="最低价:">
                            <el-input v-model="listQuery.low" placeholder="最低价" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        </el-row>
                        <el-row>
                        <el-form-item label="收盘价:">
                            <el-input v-model="listQuery.close" placeholder="收盘价" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        <el-form-item label="上一日收盘价:">
                            <el-input v-model="listQuery.preClose" placeholder="上一日收盘价" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        <el-form-item label="涨跌额:">
                            <el-input v-model="listQuery.change" placeholder="涨跌额" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        </el-row>
                        <el-row>
                        ...
                        <el-form-item label="成交额:">
                            <el-input v-model="listQuery.vol" placeholder="成交额" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        <el-form-item label="成交量:">
                            <el-input v-model="listQuery.amount" placeholder="成交量" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                        </el-form-item>
                        </el-row>
        ...
        >
            <template slot="empty">
                {{ empty_tip }}
                    ...
                    <el-table-column align="center" label="交易时间" width="150">
                        <template slot-scope="scope">
                            {{ scope.row.tradeTime }}
                        </template>
                    </el-table-column>
        ...
        <el-dialog title="个股分钟行情编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
            <el-form ref="dataForm" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
                        <el-form-item label="股票代码" prop="type">
                            <el-input v-model="temp.tsCode" readonly disabled placeholder="股票代码"/>
                        </el-form-item>
                        <el-form-item label="交易日期" prop="type">
                            <el-input v-model="temp.tradeDate" readonly disabled placeholder="交易日期"/>
                        </el-form-item>
                        <el-form-item label="交易时间" prop="type">
                            <el-input v-model="temp.tradeTime" readonly disabled placeholder="交易时间"/>
                        </el-form-item>
                        <el-form-item label="开盘价" prop="type">
                            <el-input v-model="temp.open"  placeholder="开盘价" />
                        </el-form-item>
                        <el-form-item label="最高价" prop="type">
                            <el-input v-model="temp.high"  placeholder="最高价" />
                        </el-form-item>
                        <el-form-item label="最低价" prop="type">
                            <el-input v-model="temp.low"  placeholder="最低价" />
                        </el-form-item>
                        <el-form-item label="收盘价" prop="type">
                            <el-input v-model="temp.close"  placeholder="收盘价" />
                        </el-form-item>
                        <el-form-item label="上一日收盘价" prop="type">
                            <el-input v-model="temp.preClose"  placeholder="上一日收盘价" />
                        </el-form-item>
                        <el-form-item label="涨跌额" prop="type">
                            <el-input v-model="temp.change"  placeholder="涨跌额" />
                        </el-form-item>
                        <el-form-item label="涨跌幅%" prop="type">
                            <el-input v-model="temp.pctChg"  placeholder="涨跌幅%" />
                        </el-form-item>
                        <el-form-item label="成交额" prop="type">
                            <el-input v-model="temp.vol"  placeholder="成交额" />
                        </el-form-item>
                        <el-form-item label="成交量" prop="type">
                            <el-input v-model="temp.amount"  placeholder="成交量" />
                        </el-form-item>
...
import { getDailyTimePageList, deleteDailyTimeById, insertDailyTime, updateDailyTime, getDailyTimeDetails } from '@/api/quantization/DailyTimeApi'
...
export default {
  ...
  methods: {
      getPageList() { // 查询列表分页
          getDailyTimePageList(this.listQuery).then(response => {
      ...
      deleteData(row) {
          this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
              ...
              deleteDailyTimeById(row).then(response => {
      ...
      updateData() {
          updateDailyTime(this.temp).then(response => {
              this.dialogFormVisible = false
              this.getPageList()
          })
      },
      addData() {
          insertDailyTime(this.temp).then(response => {
              this.dialogFormVisible = false
              this.getPageList()
          })
      },
      editDataDialog(row) {
          ...
          getDailyTimeDetails(row).then(response => {
