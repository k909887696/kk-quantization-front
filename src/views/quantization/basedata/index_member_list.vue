    ...
    <div class="app-container">
        <div class="filter-container">
            <el-form :inline="true" label-width="110px" label-position="right">
                    ...
                    <el-form-item label=":">
                         <el-input v-model="listQuery.indexName" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.conCode" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                    <el-form-item label=":">
                         <el-input v-model="listQuery.conName" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
                <el-row>
                    <el-form-item label=":">
                    ...
                    <el-form-item label=":">
                         <el-input v-model="listQuery.isNew" placeholder="" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
                    </el-form-item>
                </el-row>
        ...
        <el-dialog title="申万行业明细	编辑" :visible.sync="dialogFormVisible" :close-on-click-modal="false" top="50px">
            <el-form ref="dataForm" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
                ...
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.indexName"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.conCode"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.conName"  placeholder="" />
                </el-form-item>
                <el-form-item label="" prop="type">
                ...
                <el-form-item label="" prop="type">
                     <el-input v-model="temp.isNew"  placeholder="" />
                </el-form-item>
